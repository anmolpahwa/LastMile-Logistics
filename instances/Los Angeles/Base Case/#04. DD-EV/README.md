...
#### Electric van fleet
	...
	range                   :   150 miles
	speed                   :   20 mph
	refueling time          :   (150miles * 0.534 kWh/mile) / 150 kW = 0.534 hrs
	facility time           :   0.300 / 60 = 0.005 hrs
	parking time            :   2.500 / 60 = 0.042 hrs
	work load (hours)       :   9 hrs
	work load (routes)      :   6 routes
	operational cost (dist) :   ($0.175/mile + $0.120/kWh * 0.534 kWh/mile + $0.000/mile) = $0.239/mile
	operational cost (time) :   $35/hr
	fixed cost              :   $90,000 / 2814.97 = $31.972
